...
public:
	...
	*/
	...
	virtual bool execute(Board & board, Bag & bag, Dictionary & dictionary) = 0;
...
public:
	...
	/* Executes this move, whichever type it is.
	   This may throw exceptions; students: it's up to you to
	   decide (and document) what exactly it throws*/
	bool execute(Board & board, Bag & bag, Dictionary & dictionary);
...
public:
	...
	*/
	...
	std::vector<Tile*> getTileVector() const;
